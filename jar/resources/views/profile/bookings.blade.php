                                    ...
                                    <div class="booking-info">
                                        ...
                                        <div style="margin-top:10px;display:flex;gap:8px;flex-wrap:wrap;">
                                            @if($booking->status == 'approved')
                                                <a href="{{ route('bookings.show', $booking->id) }}" class="details-btn" style="background-color:#dcfce7;color:#166534;">
                                                    📞 تواصل مع المؤجر
                                                </a>
                                            @endif
                                            ...
                                            @else
                                                <a href="{{ route('bookings.payment', ['booking' => $booking->id]) }}" class="details-btn">تفاصيل الدفع</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
